...
CREATE TABLE Services (
	SERVICE_ID VARCHAR(9) PRIMARY KEY,
...
CREATE TABLE ISCount (
	YEAR INT PRIMARY KEY,
    COUNT INT
);

CREATE TABLE Bundled_Services (
	SERVICE_ID VARCHAR(9) PRIMARY KEY,
	BS_NAME VARCHAR(20) NOT NULL,
	BS_DESC VARCHAR(500),

	FOREIGN KEY (SERVICE_ID) REFERENCES Servics(SERVICE_ID)
);

CREATE TABLE BSCount (
	YEAR INT PRIMARY KEY,
    COUNT INT
);
